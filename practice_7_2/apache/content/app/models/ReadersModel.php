<?php
class ReadersModel extends Model {
    ...
    function create($entity) {
        $query = "INSERT INTO student(name, book) VALUE ('".$entity["name"]."', '".$entity["book"]."');";
    ...
    function readOne($id) {
        $query = "SELECT s.id, s.name, s.book FROM student AS s WHERE s.id = ".$id.";";
    ...
    function update($entity) {
        $query = "
            UPDATE student 
            SET name = '".$entity['name']."', book = '".$entity['surname']."' 
            WHERE id = ".$entity['id'].";
            ";
        $stmt = $this->conn->query($query);
        $this->conn->commit();
